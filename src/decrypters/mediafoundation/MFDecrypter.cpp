...
const char* CMFDecrypter::SelectKeySytem(const char* keySystem)
{
  if (strcmp(keySystem, "com.microsoft.playready"))
    return nullptr;
  return "urn:uuid:9A04F079-9840-4286-AB92-E65BE0885F95";
}

bool CMFDecrypter::OpenDRMSystem(const char* licenseURL,
