...
find_library(CURL_LIBRARY NAMES curl libcurl-d libcurl_imp
                          PATHS ${PC_CURL_LIBDIR})

find_library(CURL_LIBRARY_RELEASE NAMES libcurl
                                   PATHS ${PC_CURL_LIBDIR})
find_library(CURL_LIBRARY_DEBUG NAMES libcurl-d
                                 PATHS ${PC_CURL_LIBDIR})
...
#    if(HAS_CURL_STATIC) always static
        set_target_properties(Curl::Curl PROPERTIES
